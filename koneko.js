/*
   ...
   • My Contact https://wa.me/6288298582710
...
module.exports = conn = async (conn, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [botNumber, ...global.owner, '6288298582710@s.whatsapp.net'].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
const newReply = (teks) => {
conn.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ucapanWaktu,"body": `👋🏻 Hai kak ${pushname}`, "previewType": "PHOTO","thumbnail": logo,"sourceUrl": `https://youtu.be/YYYPJ2Ip7nY`}}}, { quoted: m })}
...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: "ʟᴀɴʙᴏᴛᴢ",
        thumbnailUrl: "https://telegra.ph/file/493be14b17af64a0125ae.jpg",
        sourceUrl: "https://chat.whatsapp.com/Dfo2eFeuQgtHtA4oLLC7Xp",
        mediaType: 1,
...
let e = String(err)
conn.sendMessage("6288298582710@s.whatsapp.net", { text: "👋🏻 Hello developer, ada yang error nih! di bagian " + util.format(e), 
contextInfo:{
